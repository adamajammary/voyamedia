...
[libUPNP](http://pupnp.sourceforge.net/) | [1.8.6](https://sourceforge.net/projects/pupnp/files/pupnp/libupnp-1.8.6/libupnp-1.8.6.tar.bz2/download) | [BSD (Berkeley Standard Distribution)](http://pupnp.sourceforge.net/#license)
